...
try:
    release = get_version("test_software_citation")
...
html_theme_options = {
    ...
    "external_links": [
        {"name": "", "url": "https://jl-wynen.github.io/"},
    ],
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/jl-wynen/test_software_citation",
            "icon": "fa-brands fa-github",
            "type": "fontawesome",
        },
        {
            "name": "PyPI",
            "url": "https://pypi.org/project/test_software_citation/",
            "icon": "fa-brands fa-python",
            "type": "fontawesome",
        },
        {
            "name": "Conda",
            "url": "https://anaconda.org/jl-wynen/test_software_citation",
...
html_title = "TestSoftwareCitation"
...
htmlhelp_basename = 'test_software_citationdoc'
